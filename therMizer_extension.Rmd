...
params@species_params$encounterpred_scale <- rep(NA, length(params@species_params$temp_min))
...
for (indv in seq(1:length(params@species_params$temp_min))) {
      ...
      # Find the maximum value of the unscaled effect of temperature on encounter and predation rate for each species 
			params@species_params$encounterpred_scale[indv] <- max((temperature) * (temperature - params@species_params$temp_min[indv]) * (params@species_params$temp_max[indv] - temperature))
...
therMizerEncounter <- function(params, n, n_pp, n_other, t, ...) {
      ...
      scaled_temp_effect <- unscaled_temp_effect / params@species_params$encounterpred_scale
